...
//     → Latency = G cycles, nhưng Fmax tăng cao hơn nhi�?u
...
module ascon_PERMUTATION #(
    ...
    // Critical path: 6×(CA+SL+LD) ≈ nhi�?u gates, nhưng với 100MHz thư�?ng OK
    // =========================================================================
    generate
    ...
    //
    // �?ây là thiết kế "pipelined" hợp lệ cho bài báo:
